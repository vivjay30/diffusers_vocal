...
orig_image = Image.open("/gscratch/realitylab/vjayaram/ffhq-dataset/images1024x1024/00000/00001.png")
...
orig_image += torch.randn_like(orig_image) * 0.1
...
image = pipe(prompt, 512, 512,
    num_inference_steps=999, original_image=orig_image, guidance_scale=0.0).images[0]
import pdb
pdb.set_trace()  
