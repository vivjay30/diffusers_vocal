...
PRETRAINED_DECODER_PATH = "/gscratch/realitylab/vjayaram/diffusers/examples/text_to_image/ffhq-likelihood/vae_trainable_may8.pth"
PRETRAINED_EMBEDDING_PATH = "/gscratch/realitylab/vjayaram/diffusers/examples/text_to_image/ffhq-likelihood/time_embeddings_may8.pth"
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if global_step % 100 == 0:  # Every N steps
                if accelerator.is_main_process:
                    torch.save(vae_trainable.state_dict(), os.path.join(args.output_dir, f"vae_trainable_dummy.pth"))
                    torch.save(time_embedding.state_dict(), os.path.join(args.output_dir, f"time_embeddings_dummy.pth"))
